...
Pod::Spec.new do |s|
  ...
  s.name         = "CB_RIPEMD"
  s.version      = "0.9.0"
  s.summary      = "caobo's CB_RIPEMD. A RIPEMD code. Copy from CoreBitcoin."
  ...
  s.source       = { :git => "https://github.com/caobo56/CB_RIPEMD.git", :tag => "0.9.0" }
  ...
  s.source_files  = "src", "CB_RIPEMD/RIPEMD/*.{h,m}"
